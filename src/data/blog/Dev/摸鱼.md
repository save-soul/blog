---
title: 程序实现快速切屏，可用于摸鱼
pubDatetime: 2025-06-30T20:49:00+08:00
description: 摸鱼是打工人对抗资本家榨取剩余价值的手段，打工人的历史就是一部摸鱼史🐶。当我们在摸鱼时，领导来了，需要快速切屏时，需要用到快捷键，但可能一键切屏更为方便。所以我用robotgo实现了Windows下一键切屏的功能。
category: 开发
...
当我们在摸鱼时，领导来了，需要快速切屏时，需要用到快捷键，但可能一键切屏更为方便。所以我用`robotgo`实现了Windows下一键切屏的功能。
...
点击[下载链接](https://static.likeit.dev/tools/moyu/moyu0.1_windows_x64.exe)即可下载。